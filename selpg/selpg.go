...
// 解析参数
func setUsage(myArgs *Args) {
	myArgs.programName = os.Args[0]
	flag.Usage = func() {
	...
	flag.IntVar(&myArgs.endPage, "e", -1, "specify end page.")
	flag.IntVar(&myArgs.pageLength, "l", -1, "specify page length(number of lines).")
	flag.BoolVar(&myArgs.pageType, "f", false, "specify type of input file.")
	flag.StringVar(&myArgs.desProgram, "d", "", "specify the destination program.")
